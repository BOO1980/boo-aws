    ...
    <aside class="sidebar" aria-label="Main navigation">
      ...
      <details class="nav-group" open>
        ...
        <nav class="nav-list" aria-label="Notes">
          <a href="${href('html-notes/html-overview.html')}" data-page="overview">HTML: Overview</a>
          <a href="${href('html-notes/html-basic-elements.html')}" data-page="basic-elements">HTML: Basic Elements</a>
          <a href="${href('html-notes/html-attributes.html')}" data-page="attributes">HTML: Attributes</a>
          <a href="${href('html-notes/html-headers.html')}" data-page="headers">HTML: Headers</a>
          <a href="${href('html-notes/html-html5-elements.html')}" data-page="html5-elements">HTML: HTML5 Elements</a>
          <a href="${href('html-notes/html-boilerplate.html')}" data-page="boilerplate">HTML: Boilerplate</a>
          <a href="${href('html-notes/html-meta-element.html')}" data-page="meta-element">HTML: Meta Element</a> 
          <a href="${href('html-notes/html-section.html')}" data-page="section">HTML: Section Element</a>
          <a href="${href('html-notes/html-images.html')}" data-page="images">HTML: Images</a>
          <a href="${href('html-notes/html-anchor.html')}" data-page="anchor">HTML: Anchor</a>
          <a href="${href('html-notes/html-lists.html')}" data-page="lists">HTML: Lists</a>
          <a href="${href('html-notes/html-emphasis-and-idiomatic-elements.html')}" data-page="emphasis-and-idiomatic-elements">HTML: Emphasis and Idiomatic Elements</a>
        </nav>
      </details>
